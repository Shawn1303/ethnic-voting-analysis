...
function App() {
	...
	switch(page) {
		...
		case "ei":
			...
			break;
		case "ensemble":
			pageHTML = <Ensemble state={state} districtplan={districtplan} setMapOutline={setMapOutline} mapOutline={mapOutline} threshold={threshold} race={race} ensemblePlan={ensemblePlan} setEnsemblePlan={setEnsemblePlan}/>
			break;
		case "compare":
			pageHTML = <></>
			break;
